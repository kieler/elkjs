...
export interface LayoutOptionsParents {
     ...
     */
    "elk.spacing.portsSurrounding"?: any;
    /** Layout Partition:
     ...
     */
    "elk.layered.directionCongruency"?: any;
    /** Feedback Edges:
     ...
     */
    "elk.layered.interactiveReferencePoint"?: any;
    /** Merge Edges:
     ...
     */
    "elk.layered.portSortingStrategy"?: any;
    /** Thoroughness:
     ...
     */
    "elk.layered.cycleBreaking.strategy"?: any;
    /** Node Layering Strategy:
     * Strategy for node layering.
     */
    "elk.layered.layering.strategy"?: any;
     ...
     */
    "elk.layered.layering.nodePromotion.strategy"?: any;
     ...
     */
    "elk.layered.crossingMinimization.strategy"?: any;
     ...
     */
    "elk.layered.crossingMinimization.greedySwitch.type"?: any;
     ...
     */
    "elk.layered.crossingMinimization.greedySwitchHierarchical.type"?: any;
    /** Node Placement Strategy:
     * Strategy for node placement.
     */
    "elk.layered.nodePlacement.strategy"?: any;
     ...
     */
    "elk.layered.nodePlacement.bk.edgeStraightening"?: any;
    /** BK Fixed Alignment:
     ...
     */
    "elk.layered.nodePlacement.bk.fixedAlignment"?: any;
     ...
     */
    "elk.layered.nodePlacement.networkSimplex.nodeFlexibility.default"?: any;
    /** Spline Routing Mode:
     ...
     */
    "elk.layered.edgeRouting.splines.mode"?: any;
     ...
     */
    "elk.layered.compaction.postCompaction.strategy"?: any;
    /** Post Compaction Constraint Calculation:
     * Specifies whether and how post-process compaction is applied.
     */
    "elk.layered.compaction.postCompaction.constraints"?: any;
     ...
     */
    "elk.layered.wrapping.strategy"?: any;
     ...
     */
    "elk.layered.wrapping.cutting.strategy"?: any;
     ...
     */
    "elk.layered.wrapping.validify.strategy"?: any;
     ...
     */
    "elk.layered.considerModelOrder.strategy"?: any;
     ...
     */
    "elk.layered.considerModelOrder.components"?: any;
     ...
     */
    "elk.layered.considerModelOrder.longEdgeStrategy"?: any;
     ...
     */
    "elk.radial.optimizationCriteria"?: any;
    /** Force Model:
     ...
     */
    "elk.polyomino.traversalStrategy"?: any;
     ...
     */
    "elk.disco.componentCompaction.strategy"?: any;
     ...
     */
    "elk.processingOrder.rootSelection"?: any;
    /** Compaction Strategy:
     * This option defines how the compaction is applied.
     */
    "elk.compaction.compactionStrategy"?: any;
...
export interface LayoutOptionsNodes {
     ...
     */
    "elk.layered.layering.layerConstraint"?: any;
     ...
     */
    "elk.rectpacking.optimizationGoal"?: any;
    /** Shift Last Placed.:
